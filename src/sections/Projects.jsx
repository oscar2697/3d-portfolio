...
const Projects = () => {
    ...
    const currentPorject = myProjects[selectedProjectIndex]
    ...
    return (
        <section className="c-space my-20" id="work">
            <div className="head-text">Mein Work</div>
            ...
            <div className="grid lg:grid-cols-2 grid-cols-1 mt-12 gap-5 w-full">
                <div className="flex flex-col gap-5 relative sm:p-10 py-10 px-5 shadow-2xl">
                    ...
                    <div className="flex flex-col gap-5 text-white-600 my-5">
                        <p className="text-white text-2xl font-semibold animatedText">{currentPorject.title} </p>
                        ...
                        <Center>
                            <Suspense fallback={<CanvasLoader />}>
                                <group 
                                    ...
                                    rotation={[0, -0.1, 0]} 
                                >
                                    <DemoComputer texture={currentPorject.texture} />
                                </group>
                            </Suspense>
                        </Center>
